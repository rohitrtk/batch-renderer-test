...
Application::Application() :
  ...
  m_Texture = std::make_unique<Texture>("assets/textures/face.png");

  for (auto& sprite : m_Sprites) {
    glm::vec2 pos(Random::Vec2({0.0f, 0.0f}, {static_cast<float>(k_WindowWidth), static_cast<float>(k_WindowHeight)}));
    glm::vec3 col(Random::Vec3({0.1f, 0.1f, 0.1f}, {1.0f, 1.0f, 1.0f}));
